...
class Llama(Module):
    ...
    def init_weights(self):
        ...
        for name in params:
            ...
            if name.endswith('.W') and ('attn' in name or 'ffn' in name or 'embeddings' in name or 'output_projection' in name):
            ...
            if name.endswith('attn.W_o.W') or name.endswith('ffn.w3.W'):
                print(name)
